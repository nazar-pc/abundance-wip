...
use crate::fused::rv32::zbb::Rv32ZbbFusedInstruction;
use crate::rv32::test_utils::{TestInterpreterState, execute, initialize_state};
use ab_riscv_primitives::prelude::*;
use alloc::format;

type Fused = Rv32ZbbFusedInstruction<Reg<u32>>;
...
fn prepare_bits(state: &mut TestInterpreterState<Fused>) {
    state.regs.write(Reg::A1, 0x0f0f_0f0f);
    state.regs.write(Reg::A2, 0x3333_5555);
}
