//! Fused instructions of the RISC-V RV32 M extension
...
#[instruction(inherit = [Rv32Instruction, Rv32MInstruction])]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum Rv32MFusedInstruction<Reg> {
...
const _: () = {
    ...
    assert!(
        size_of::<Rv32MFusedInstruction<Reg<u32>>>() == size_of::<Rv32Instruction<Reg<u32>>>(),
        "Fused instructions must fit into an instruction of the instruction set they extend"
    );
};

#[instruction]
const impl<Reg> Instruction for Rv32MFusedInstruction<Reg>
where
...
#[instruction]
const impl<Reg> FusedInstruction for Rv32MFusedInstruction<Reg>
where
    Reg: [const] Register<Type = u32>,
{
    #[inline(always)]
...
#[instruction]
impl<Reg> fmt::Display for Rv32MFusedInstruction<Reg>
where
...
const impl<Reg> ExecutableInstructionOperands for Rv32MFusedInstruction<Reg> where
    Reg: Register<Type = u32>
{
}

#[instruction_execution]
const impl<Reg, Env> ExecutableInstructionCsr<Env> for Rv32MFusedInstruction<Reg> where
    Reg: Register<Type = u32>
{
}
