...
use crate::fused::rv32::zca::Rv32ZcaFusedInstruction;
use crate::rv32::test_utils::{TestInterpreterState, execute, initialize_state};
use ab_riscv_primitives::prelude::*;
use alloc::format;

type Fused = Rv32ZcaFusedInstruction<Reg<u32>>;
...
fn prepare_condition(rs1_value: u32) -> impl Fn(&mut TestInterpreterState<Fused>) {
    move |state| {
