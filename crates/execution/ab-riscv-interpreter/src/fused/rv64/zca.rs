//! Fused instructions of the RISC-V RV64 Zca extension
...
pub enum Rv64ZcaFusedInstruction<Reg> {
    // Branch over `c.mv`
...
const _: () = {
    ...
    assert!(
        size_of::<Rv64ZcaFusedInstruction<Reg<u64>>>() == size_of::<Rv64Instruction<Reg<u64>>>(),
        "Fused instructions must fit into an instruction of the instruction set they extend"
    );
};

#[instruction]
const impl<Reg> Instruction for Rv64ZcaFusedInstruction<Reg>
where
...
#[instruction]
const impl<Reg> FusedInstruction for Rv64ZcaFusedInstruction<Reg>
where
    Reg: [const] Register<Type = u64>,
{
    #[inline(always)]
...
#[instruction]
impl<Reg> fmt::Display for Rv64ZcaFusedInstruction<Reg>
where
...
const impl<Reg> ExecutableInstructionOperands for Rv64ZcaFusedInstruction<Reg> where
    Reg: Register<Type = u64>
{
}

#[instruction_execution]
const impl<Reg, Env> ExecutableInstructionCsr<Env> for Rv64ZcaFusedInstruction<Reg> where
    Reg: Register<Type = u64>
{
}
...
const impl<Reg, Regs, Env, Memory, PC> ExecutableInstruction<Regs, Env, Memory, PC>
    for Rv64ZcaFusedInstruction<Reg>
where
    Reg: [const] Register<Type = u64>,
